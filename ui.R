             ...
             tabPanel("Interactive map",
                      ...
                      div(class="outer",
                          ...
                          absolutePanel(
                            ...
                            br(),
                            sliderInput(inputId = "size", label = "Size", min = 0, max = 70000, value = c(0, 70000)),
                            ...
                            hidden(
                              sliderInput(inputId = "tuition", label = "Average Out-Of-State Tuition & Fees", min = 0, max = 70000, value = 70000),
                              checkboxInput(inputId = "na_tuition", label = "Inlcude NA?", value = TRUE),
                              
                              sliderInput(inputId = "debt", label = "Median Debt Upon Completion", min = 0, max = 70000, value = 70000),
                              checkboxInput(inputId = "na_debt", label = "Inlcude NA?", value = TRUE),
                              
                              sliderInput(inputId = "earnings", label = "Median Earnings 6 years After Entry", min = 0, max = 120000, value = 120000),
                            ...
                            hidden(
                              # admissions rate
                              sliderInput(inputId = "admissions", label = "Admissions Rate", min = 0, max = 1, post = "%", value = c(0, 1)),
                              checkboxInput(inputId = "na_admissions", label = "Inlcude NA?", value = TRUE),

                              # ACT scores
                              sliderInput(inputId = "act", label = "ACT Scores (25th Percentile)", min = 1, max =  36, value = c(1, 36)),
                              checkboxInput(inputId = "na_act", label = "Inlcude NA?", value = TRUE),

                              # SAT scores
                              sliderInput(inputId = "sat_verbal", label = "SAT Verbal Scores (25th Percentile)", min = 200, max = 800, value = c(200, 800)),
                              sliderInput(inputId = "sat_math", label = "SAT Math Scores (25th Percentile)", min = 200, max = 800, value = c(200, 800)),
